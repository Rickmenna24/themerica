...
!function(t){var o=null,r=null,i=null,e=!0;t.extend(t.Isotope.prototype,{_perfectMasonryReset:function(){this.options.perfectMasonry=this.options.perfectMasonry||{};var s="horizontal"!=this.options.perfectMasonry.layout,n=1==this.options.perfectMasonry.liquid;e&&(e=!1,o=this,r=t(this.element.context),i=r.parent(),this.options.perfectMasonry.minCols=this.options.perfectMasonry.minCols||1,this.options.perfectMasonry.minRows=this.options.perfectMasonry.minRows||1,this.options.perfectMasonry.maxCols=this.options.perfectMasonry.maxCols||9999,this.options.perfectMasonry.maxRows=this.options.perfectMasonry.maxRows||9999),n&&t.data(window,"events")&&t._data(window,"events").smartresize&&(t(window).off("smartresize.isotope"),t(window).on("resize.isotope.perfectmasonry",function(){r.hasClass("isotope")&&r.isotope("reLayout")}));var a=this.perfectMasonry={};if(this._getSegments(),this._getSegments(!0),this._perfectMasonryGetSegments(),n){var h=i.width(),c=i.height();this.options.perfectMasonry.columnWidth=this.options.perfectMasonry.columnWidth||a.columnWidth,this.options.perfectMasonry.rowHeight=this.options.perfectMasonry.rowHeight||a.rowHeight,a.cols=this.options.perfectMasonry.cols||Math.floor(h/this.options.perfectMasonry.columnWidth),a.rows=this.options.perfectMasonry.rows||Math.floor(c/this.options.perfectMasonry.rowHeight),a.cols=Math.min(Math.max(a.cols,this.options.perfectMasonry.minCols),this.options.perfectMasonry.maxCols),a.rows=Math.min(Math.max(a.rows,this.options.perfectMasonry.minRows),this.options.perfectMasonry.maxRows);var p=s?a.columnWidth/(h/a.cols):a.rowHeight/(c/a.rows);a.columnWidth=Math.floor(a.columnWidth/p),a.rowHeight=Math.floor(a.rowHeight/p)}a.grid=new Array(this.perfectMasonry.cols),a.containerHeight=0,a.containerWidth=0},_perfectMasonryLayout:function(o){var r=this,i=this.perfectMasonry,e="horizontal"!=r.options.perfectMasonry.layout,s=1==r.options.perfectMasonry.liquid;if(i.grid=new Array(i[e?"cols":"rows"]),i.grid&&i.grid.length){o.each(function(){var o=t(this),n=s?o.data("colSpan"):Math.ceil(o.outerWidth()/(i.columnWidth+1)),a=s?o.data("rowSpan"):Math.ceil(o.outerHeight()/(i.rowHeight+1));n||(n=Math.ceil(o.outerWidth(!0)/(i.columnWidth+1)),a=Math.ceil(o.outerHeight(!0)/(i.rowHeight+1)),o.data("colSpan",n),o.data("rowSpan",a));for(var h=e?n:a,c=e?a:n,p=Math.max((e?i.cols-n:i.rows-a)+1,1),f=-1,l=0,M=0;++f<1e4;){i.grid[f]=i.grid[f]||[];for(var d=0;p>d;d++){var g=i.grid[f][d];if(!g){var y=!0;if(n>1||a>1)for(var w=0;h>w;w++){for(var m=0;c>m;m++)if(i.grid[f+m]=i.grid[f+m]||[],i.grid[f+m][d+w]){y=!1;break}if(!y)break}if(y){for(var w=0;h>w;w++)for(var m=0;c>m;m++)i.grid[f+m][d+w]=!0;var l=f,M=d;if(e)var l=d,M=f;return i.containerWidth=Math.max(i.containerWidth,(l+h)*i.columnWidth),i.containerHeight=Math.max(i.containerHeight,(M+c)*i.rowHeight),1==r.options.perfectMasonry.liquid&&o.css({width:i.columnWidth*n,height:i.rowHeight*a}),void r._pushPosition(o,l*i.columnWidth,M*i.rowHeight)}}}}r._pushPosition(o,-9999,-9999)});var n=e?i.grid.length:i.grid[0]&&i.grid[0].length,a=e?i.grid[0]&&i.grid[0].length:i.grid.length;t(this.element.context).attr("data-isotope-rows",n).attr("data-isotope-cols",a)}},_perfectMasonryGetContainerSize:function(){return{width:this.perfectMasonry.containerWidth,height:this.perfectMasonry.containerHeight}},_perfectMasonryResizeChanged:function(){var t=this.perfectMasonry,o=t.cols,r=t.rows;return this._perfectMasonryGetSegments(),"horizontal"==this.options.perfectMasonry.layout&&r!==t.rows?!0:o!==t.cols?!0:!1},_perfectMasonryGetSegments:function(){var t=this.perfectMasonry,o=this.options.perfectMasonry.parent||this.element.parent(),r=o.width();t.cols=Math.floor(r/t.columnWidth)||1;var i=o.height();t.rows=Math.floor(i/t.rowHeight)||1}})}(jQuery);
